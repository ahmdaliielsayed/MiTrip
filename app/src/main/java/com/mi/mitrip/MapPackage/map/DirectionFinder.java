...
public class DirectionFinder {
    ...
    private static final String GOOGLE_DIRECTION_API_KEY = "AIzaSyCShYBlgJ1uU6HDzGC8XBOcipdwMIhlcA8";  // replace with your google direction api
    ...
    private void parseJSon(String data) throws JSONException {
        if (data == null)
            return;
        System.out.println("parseJSon(String data) throws JSONException"+data);
